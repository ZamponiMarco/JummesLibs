...
public class VersionWrapper_v1_16_R1 implements VersionWrapper {

    @Override
    public ItemStack skullFromValue(String value) {
        UUID id = new UUID(value.hashCode(), value.hashCode());
        net.minecraft.server.v1_16_R1.ItemStack nmsItem = CraftItemStack.asNMSCopy(new ItemStack(Material.PLAYER_HEAD));
    ...
    public ItemMeta deserializeItemMeta(Map<String, Object> map) {
        Class clazz = null;
        try {
            clazz = Class.forName("org.bukkit.craftbukkit.v1_16_R1.inventory.CraftMetaItem");
