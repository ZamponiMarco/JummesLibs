...
import com.github.jummes.libs.wrapper.ProtocolWrapper;
...
public class Libs {
    ...
    @Getter
    private static ProtocolWrapper protocolWrapper;
    ...
    private static void setUpWrappers(JavaPlugin plugin) {
