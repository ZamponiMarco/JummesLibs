...
public class MapperUtils {
    ...
    public static Function<Object, ItemStack> getEntityTypeMapper() {
        return obj -> {
            ...
            return ItemUtils.getNamedItem(Libs.getVersionWrapper().skullFromValue(entities.getOrDefault(type.name(), "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTNjOGFhM2ZkZTI5NWZhOWY5YzI3ZjczNGJkYmFiMTFkMzNhMmU0M2U4NTVhY2NkNzQ2NTM1MjM3NzQxM2IifX19")),
    ...
    public static Function<Object, ItemStack> particlesMapper() {
        return obj -> {
            ...
            return ItemUtils.getNamedItem(Libs.getVersionWrapper().skullFromValue("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNDQ2MWQ5ZDA2YzBiZjRhN2FmNGIxNmZkMTI4MzFlMmJlMGNmNDJlNmU1NWU5YzBkMzExYTJhODk2NWEyM2IzNCJ9fX0="),
